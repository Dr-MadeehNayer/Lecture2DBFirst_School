...
namespace Lecture2DBFirst_School {
    ...
    public partial class Courses : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CourseRow AddCourseRow(string Title, int Credits, string CourseDescription, string InstructorId) {
            ...
            private void InitClass() {
                ...
                this.columnInstructorId.MaxLength = 128;
            }
...
namespace Lecture2DBFirst_School.CoursesTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([Title], [Credits], [CourseDescription], [InstructorI" +
                "d]) VALUES (@Title, @Credits, @CourseDescription, @InstructorId)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Course] SET [Title] = @Title, [Credits] = @Credits, [CourseDescript" +
                "ion] = @CourseDescription, [InstructorId] = @InstructorId WHERE (([CourseId] = @" +
                "Original_CourseId))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CourseId, Title, Credits, CourseDescription, InstructorId FROM dbo.Course";
        ...
        public virtual int Insert(string Title, global::System.Nullable<int> Credits, string CourseDescription, string InstructorId) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, global::System.Nullable<int> Credits, string CourseDescription, string InstructorId, int Original_CourseId) {
            if ((Title == null)) {
